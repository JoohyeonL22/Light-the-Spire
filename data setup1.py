...
def process_runs(data_dir, name):
    file_not_opened = 0
    bad_file_count = 0
    total_file_count = 0
    ...
    for root, dirs, files in os.walk(data_dir):
        for fname in files:
            ...
            if path.endswith(".run.json"):
                ...
                # Save batch to file
                if len(fight_training_examples) > 30000:
                    print('Saving batch')
...
directory2 = "D:/문서/슬더스 데이터/2020-12/2020-12-01/"
...
for i in range(1, 32):
    ...
    a[-2]=temp[1]
    directory = ''.join(a)
    nametemp = directory[22:-1]
    name = 'data_z'+nametemp+'.json'
    #print(directory)
    process_runs(directory, name)


"""
nametemp = directory2[22:-1]
name = 'data_z'+nametemp+'.json'
process_runs(directory2, name)
"""
